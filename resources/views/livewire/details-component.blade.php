                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="submit" wire:click.prevent="store({{$product->id}}, '{{$product->name}}', {{$product->regular_price}})" class="button button-add-to-cart">Add to cart</button>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($nproducts as $nproduct)
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{asset('assets/imgs/shop/thumbnail-')}}{{$nproduct->id}}.jpg" alt="#">
                                    </div>
